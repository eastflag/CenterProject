...
public class CryptographyPasswordHash {
	...
	public static String computePasswordHash(String aPassword, byte[] aSalt) throws NoSuchAlgorithmException{
	...
	public static boolean verifyPassword(String aPassword, String aPasswordHash) throws NoSuchAlgorithmException{
